    ...
    def evaluate_entry_metrics(self, ctx: Dict[str, Any], params: MCParams, seed: int) -> Dict[str, Any]:
        ...
        for i in range(len(policy_horizons)):
            ...
            if alpha_hit is None:
                ...
                tp_pL_val = beta_eff * tp_pL_pred + (1.0 - beta_eff) * p_tp_L_mc
                sl_pL_val = beta_eff * sl_pL_pred + (1.0 - beta_eff) * p_sl_L_mc
                tp_pS_val = beta_eff * tp_pS_pred + (1.0 - beta_eff) * p_tp_S_mc
                sl_pS_val = beta_eff * sl_pS_pred + (1.0 - beta_eff) * p_sl_S_mc
